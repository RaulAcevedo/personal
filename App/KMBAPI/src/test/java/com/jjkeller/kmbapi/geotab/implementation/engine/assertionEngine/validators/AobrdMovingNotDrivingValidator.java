...
/**
 * ValidityMappingBase implementation for AobrdMovingNotDriving
 */
public class AobrdMovingNotDrivingValidator extends StateValidityMappingBase<AobrdMovingNotDriving> {

    public AobrdMovingNotDrivingValidator(AobrdMovingNotDriving startingStateInstance, Class<? extends State> endStateClass, HashMap testMappings, StateValidityMappingBase originatingValidator) throws Exception {
