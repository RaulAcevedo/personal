...
public class CaliforniaIntrastateProperty extends PropertyCarrying
{
	private static final String REGULATORY_SECTION_STANDARD = "C3";

	public CaliforniaIntrastateProperty(com.jjkeller.kmbapi.calcengine.RulesetProperties properties)
	{
		super(properties);
	}
