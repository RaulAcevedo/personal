...
public class USConstruction8DayProperty extends USConstructionRulesetBase {

    private static final String REGULATORY_SECTION_STANDARD = "U8";

    public USConstruction8DayProperty(RulesetProperties properties)
    {
        super(properties);
    }

    public USConstruction8DayProperty(RulesetProperties properties, ILogCheckerComplianceDatesController complianceDateController)
    {
