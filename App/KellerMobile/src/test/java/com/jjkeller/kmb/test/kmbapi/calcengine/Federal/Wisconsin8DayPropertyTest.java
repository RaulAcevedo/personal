...
public class Wisconsin8DayPropertyTest extends KmbRoboTestBase {

    @Test
    public void test_Standard() {

        ProcessEventHelper event = new ProcessEventHelper(RuleSetTypeEnum.Wisconsin_8Day, RulesetFactory.ForWisconsin8DayProperty());
