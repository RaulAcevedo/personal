...
public class Wisconsin7DayPassengerTest extends KmbRoboTestBase {

    @Test
    public void test_Standard() {
        setupAppSettingsMocks();

        ProcessEventHelper event = new ProcessEventHelper(RuleSetTypeEnum.Wisconsin_7Day, RulesetFactory.ForWisconsin7DayPassenger());
