...
public class CalcEngineTestHelpers {

    private IHosRulesetCalcEngine _rulesetEngine = null;
    private RuleSetTypeEnum _ruleset = null;

    public CalcEngineTestHelpers(IHosRulesetCalcEngine engine, RuleSetTypeEnum ruleset) {
        this._rulesetEngine = engine;
    ...
    public void ProcessEvent(String eventInfo) {
        ...
        // Not using tokens[3] apparently
        String expectedDriveAvailable = tokens[4];
        String expectedDutyAvailable = tokens[5];
        String expectedWeeklyAvailable = tokens[6];

        this.AssertResults(summary, expectedDriveAvailable, expectedDutyAvailable, expectedWeeklyAvailable);
    }
